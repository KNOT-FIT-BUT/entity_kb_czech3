...
__GENERIC_URL_WIKIDATA = "__GENERIC:WIKIDATA URL"
...
MAP_NEWCOLS_OLDCOLS = {
    ...
    __GENERIC_URL_WIKIDATA: "WIKIDATA ID",
        ...
        for line in fin_kb:
            ...
            for out_type in out_alltypes:
                for out_column, trash in MAP_TYPES_COLUMNS[out_type].items():
                    ...
                    elif out_column == __GENERIC_URL_WIKIDATA:
                        if in_data[in_columns[in_type][MAP_NEWCOLS_OLDCOLS[out_column]]]:
                            out_data.append("https://www.wikidata.org/wiki/" +
                                            in_data[in_columns[in_type][MAP_NEWCOLS_OLDCOLS[out_column]]])
                        else:
                            out_data.append("")
