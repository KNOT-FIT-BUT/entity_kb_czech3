...
sed -i '/^$/d' HEAD-KB &&
sed -i '$G' HEAD-KB &&
python3 prepare_kb_to_stats_and_metrics.py < kb_en | python3 check_columns_in_kb.py --cat | python3 wiki_stats_to_KB.py > KBstats.all &&
...
(( exit_status == 0 )) && rm kb_en KBstats.all wiki_stats
